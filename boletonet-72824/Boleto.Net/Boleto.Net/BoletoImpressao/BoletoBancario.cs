...
namespace BoletoNet
{
    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string GetReportPath()
        {
            ...
            FileStream fs = new FileStream(result, FileMode.Create, FileAccess.ReadWrite);
            BinaryWriter bw = new BinaryWriter(fs);
            bw.Write(Properties.Resources.boleto_comprovante);
            bw.Close(); //Thanks Karlo for pointing out!
            
            return result;
        }

        public DataTable GetDataTableBoleto(List<Boleto> pBoletos)
        {
            dsBoleto.BoletoDataTable dtBoleto = new dsBoleto.BoletoDataTable();

            foreach(Boleto b in pBoletos)
            {
                dsBoleto.BoletoRow dr = dtBoleto.NewBoletoRow();

                dr.Abatimento = b.Abatimento;
                dr.Aceite = b.Aceite;
                dr.BancoCodigo = b.Banco.Codigo;
                dr.BancoDigito = b.Banco.Digito;
                dr.BancoNome= b.Banco.Nome;
                dr.Carteira = b.Carteira;
                dr.Categoria = b.Categoria;
                dr.CedenteCodigo = b.Cedente.Codigo;
                dr.CedenteContaBancariaAgencia = b.Cedente.ContaBancaria.Agencia;
                dr.CedenteContaBancariaConta = b.Cedente.ContaBancaria.Conta;
                dr.CedenteContaBancariaDigitoAgencia = b.Cedente.ContaBancaria.DigitoAgencia;
                dr.CedenteContaBancariaDigitoConta = b.Cedente.ContaBancaria.DigitoConta;
                dr.CedenteContaBancariaOperacaConta = b.Cedente.ContaBancaria.OperacaConta;
                dr.CedenteConvenio = b.Cedente.Convenio;
                dr.CedenteCPFCNPJ = b.Cedente.CPFCNPJ;
                dr.CedenteDigitoCedente = b.Cedente.DigitoCedente;
                dr.CedenteNome = b.Cedente.Nome;
                
                dr.CodigoBarra = b.CodigoBarra.LinhaDigitavel;
                
                C2of5i cb = new C2of5i();
                cb.Code = b.CodigoBarra.LinhaDigitavel;
                dr.CodigoBarraImg = cb.ToByte();

                dr.DataDesconto = b.DataDesconto;
                dr.DataDocumento = b.DataDocumento;
                dr.DataJurosMora = b.DataJurosMora;
                dr.DataMulta = b.DataMulta;
                dr.DataOutrosAcrescimos = b.DataOutrosAcrescimos;
                dr.DataOutrosDescontos = b.DataOutrosDescontos;
                dr.DataProcessamento = b.DataProcessamento;
                dr.DataVencimento = b.DataVencimento;
                dr.Especie = b.Especie;
                dr.EspecieDocumento = b.EspecieDocumento.Sigla;

                if(b.Instrucoes[0] != null)
                    dr.InstrucoesLinha1 = b.Instrucoes[0].Descricao;

                if (b.Instrucoes[1] != null)
                    dr.InstrucoesLinha2 = b.Instrucoes[1].Descricao;

                if (b.Instrucoes[2] != null)
                    dr.InstrucoesLinha3 = b.Instrucoes[2].Descricao;

                if (b.Instrucoes[3] != null)
                    dr.InstrucoesLinha4 = b.Instrucoes[3].Descricao;

                dr.IOF = b.IOF;
                dr.JurosMora = b.JurosMora;
                dr.LocalPagamento = b.LocalPagamento;
                dr.Moeda = b.Moeda;
                dr.NossoNumero = b.NossoNumero;
                dr.NumeroDocumento = b.NumeroDocumento;
                dr.OutrosAcrescimos = b.OutrosAcrescimos;
                dr.OutrosDescontos = b.OutrosDescontos;
                dr.QuantidadeMoeda = b.QuantidadeMoeda;
                dr.SacadoCPFCNPJ = b.Sacado.CPFCNPJ;
                dr.SacadoEnderecoBairro = b.Sacado.Endereco.Bairro;
                dr.SacadoEnderecoCEP = b.Sacado.Endereco.CEP;
                dr.SacadoEnderecoCidade = b.Sacado.Endereco.Cidade;
                dr.SacadoEnderecoComplemento = b.Sacado.Endereco.Complemento;
                dr.SacadoEnderecoEmail = b.Sacado.Endereco.Email;
                dr.SacadoEnderecoEnd = b.Sacado.Endereco.End;
                dr.SacadoEnderecoLogradouro = b.Sacado.Endereco.Logradouro;
                dr.SacadoEnderecoNumero = b.Sacado.Endereco.Numero;
                dr.SacadoEnderecoUF = b.Sacado.Endereco.UF;
                dr.SacadoNome = b.Sacado.Nome;
                dr.TipoModalidade = b.TipoModalidade;
                dr.UsoBanco = b.UsoBanco;
                dr.ValorBoleto = b.ValorBoleto;
                dr.ValorDesconto = b.ValorDesconto;
                dr.ValorMoeda = b.ValorMoeda;
                dr.ValorMulta = b.ValorMulta;

                dtBoleto.Rows.Add(dr);
            }
