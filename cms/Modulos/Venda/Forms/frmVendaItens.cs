...
{
    public partial class frmVendaItens : cms.Modulos.Util.WindowBase
    {
        ...
        Produto.Forms.Produto.frmProdutoPhoto fotoShow = new Produto.Forms.Produto.frmProdutoPhoto();

        public frmVendaItens()
        {
            InitializeComponent();
        }
        ...
        private void AtualizarGvProduto()
        {
            ...
            try
            {
                produtos = cProduto.ProdutoProcurar(id_produto, id_produto_grupo, id_produto_subgrupo, id_produto_familia, id_produto_subfamilia, id_empresa, oVenda.id_produto_preco_tabela, descricao, referencia, codigo_barra, codigo_barra_fornecedor);
            }
            catch { }
        ...
        public void Preencher()
        {
            ...
            for (int i = 0; i < gvProduto.Rows.Count; i++)
            {
                ...
                if (cVenda.ProdutoExistItem(id_venda, p.id_produto))
                {
        ...
        private void frmVendaItens_Load(object sender, EventArgs e)
        {
            ...
            oVenda = cVenda.GetVendaByID(id_venda);

            cbFilial.Enabled = false;
            cbFilial.SetSelectedValue(oVenda.id_empresa.ToString());
        }
        CheckBox chkTodos;
        ...
        private void btAdicionar_Click(object sender, EventArgs e)
        {
            ...
            cVenda.VendaItensCadastrar(id_venda, lId_produto);

            MessageBox.Show(null, "Itens incluidos com sucesso!", "Itens da venda.", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
