    ...
    public class ServicoPendenteDAL : DALObject
    {
        ...
        protected override void DataReaderToPersistentObject(System.Data.IDataReader dataReader, BusinessObject businessObject, string radical)
        {
            ...
            try
            {
                ...
                pend.tipoAmbiente = (NFe2.SchemaXML.TAmb)Utils.FieldAsInt32(dataReader, "TipoOperacao");
                pend.tipoEmissao = (NFe2.SchemaXML.TNFeInfNFeIdeTpEmis)Utils.FieldAsInt32(dataReader, "ModoOperacao");
                pend.UF = (NFe2.SchemaXML.TCodUfIBGE)Utils.FieldAsInt32(dataReader, "UnidadeFederativa");
        ...
        {
            return @"INSERT INTO ServicosPendentes(ModoOperacao, TipoOperacao, UnidadeFederativa, NumeroLote, CodigoSituacao, DataSituacao, NumeroRecibo, XMLRecibo, CNPJ, erroEnvio, xmlRetConsulta)
                          VALUES(@ModoOperacao, @TipoOperacao, @UnidadeFederativa, @NumeroLote, @CodigoSituacao, @DataSituacao, @NumeroRecibo, @XMLRecibo, @CNPJ, @erroEnvio, @xmlRetConsulta)";
        }
...
//                        AND CNPJ = @CNPJ";
        ...
        {
            return @"SELECT ModoOperacao, TipoOperacao, UnidadeFederativa, NumeroLote, CodigoSituacao, DataSituacao, NumeroRecibo, XMLRecibo, CNPJ, erroEnvio, xmlRetConsulta
