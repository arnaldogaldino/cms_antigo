...
namespace RDI.NFe2.Business
{
    public static class ConverteNFe
    {
        ...
        private static TUf DefineUF(String UF)
        {
            try
            {
                return (RDI.NFe2.SchemaXML.TUf)Enum.Parse(typeof(RDI.NFe2.SchemaXML.TUf), UF);
            }
            catch
            {
        ...
        //        RDI.NFe2.SchemaXML.TNFeInfNFeIdeNFrefRefNF refNF = new RDI.NFe2.SchemaXML.TNFeInfNFeIdeNFrefRefNF();
